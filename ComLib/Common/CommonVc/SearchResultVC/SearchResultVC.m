...
@interface SearchResultVC () <SearchResultDataSourceDelegate>

@property (nonatomic, strong) SearchResultDataSource *dataSources;
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        //delegate
        _dataSources = [[SearchResultDataSource alloc] init];
